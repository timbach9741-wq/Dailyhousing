            ...
            <nav className="bg-white shadow-sm border-b border-slate-100">
                <div className="w-full px-4 sm:px-6 lg:px-12 flex items-center justify-between py-3">
                    ...
                    <Link to="/" className="flex items-center gap-3.5 group">
                        <img src="/assets/images/daily_housing_icon.svg" alt="데일리하우징 로고" className="h-12 w-12 sm:h-14 sm:w-14" />
                            ...
                            {isAuthenticated ? (
                                <div className="space-y-2">
                                    ...
                                    <button
                                        ...
                                        className="w-full px-4 py-3 text-[15px] font-bold text-red-500 bg-red-50 hover:bg-red-100 rounded-lg text-center flex items-center justify-center gap-2 transition-colors"
                                    >

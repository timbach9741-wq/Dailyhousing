...
// 시트 스탠다드 2.0(은행목) 전용 상세 이미지
const SHEET_20_IMAGES = [
    "https://octapi.lxzin.com/imageResource/file/202403/19/ab1316c7-cfd4-4e79-b028-af80a6ad21ae.png", // 메인 히어로
    "https://octapi.lxzin.com/imageResource/file/202403/18/1db54701-3e24-4375-8ba5-cb679efa5250.png", // 아이콘: 친환경 바닥재
    "https://octapi.lxzin.com/imageResource/file/202403/19/2d4ec413-ddb5-49b9-a95e-9e7ef0f0c1ec.png", // 아이콘: 튼튼한 바닥재
    "https://octapi.lxzin.com/imageResource/file/202403/18/d4fb4596-d1e5-4155-a850-f744302d85ee.png", // 아이콘: 세련된 디자인
    "https://octapi.lxzin.com/imageResource/file/202403/19/98321328-8bc5-4c46-9652-a830193c751e.png", // 제품 구조도
    "https://octapi.lxzin.com/imageResource/file/202403/19/72d0f7d9-e133-44eb-b5f2-219c0ee0a5a3.png", // 튼튼한 바닥재 이미지
...
function SheetStandard20Feature() {
    return (
        <div style={{ width: '100%', maxWidth: '970px', margin: '0 auto', padding: '0 20px 150px', fontFamily: "'Noto Sans KR', sans-serif", boxSizing: 'border-box' }}>
            ...
            <div style={{ marginBottom: '200px' }}>
                <p style={{ margin: 0, color: '#999999', fontSize: '16px' }}>
                    ※ 기존의 '은행목' 제품명이 '시트 스탠다드 2.0'으로 변경되었습니다.
                </p>
            </div>

            {/* LX Z:IN 바닥재 시트 스탠다드 2.0 */}
            <div style={{ marginBottom: '200px' }}>
                ...
                <span style={{ display: 'block', margin: 0, paddingTop: '30px', fontSize: '14px', textAlign: 'center', wordSpacing: '-1px' }}>
                    &nbsp;트렌디하고 합리적인 가격의 시트바닥재, LX Z:IN 바닥재 시트 스탠다드 2.0입니다.&nbsp;
                </span>
                <img src={SHEET_20_IMAGES[0]} alt="트렌디하고 합리적인 가격의 시트바닥재, 은행목입니다." style={{ display: 'block', margin: 0, paddingTop: '24px', width: '100%' }} />
                ...
                <div style={{ display: 'flex', flexWrap: 'nowrap', justifyContent: 'space-between', alignItems: 'stretch', marginTop: '10px', gap: '10px' }}>
                    <div style={{ display: 'flex', flex: '1', height: '120px', justifyContent: 'center', alignItems: 'center', border: '1px solid #e9e9e9' }}>
                        <div style={{ paddingRight: '16px' }}>
                            <img src={SHEET_20_IMAGES[1]} alt="친환경 바닥재" style={{ display: 'block', margin: 0 }} />
                        </div>
                        <div>
                    ...
                    <div style={{ display: 'flex', flex: '1', height: '120px', justifyContent: 'center', alignItems: 'center', border: '1px solid #e9e9e9' }}>
                        <div style={{ paddingRight: '16px' }}>
                            <img src={SHEET_20_IMAGES[2]} alt="튼튼한 바닥재" style={{ display: 'block', margin: 0 }} />
                        </div>
                        <div>
                            <span style={{ display: 'block', fontSize: '16px' }}>두꺼운 표면층</span>
                            <strong style={{ display: 'block', fontSize: '16px' }}>튼튼한 바닥재</strong>
                        </div>
                    </div>
                    <div style={{ display: 'flex', flex: '1', height: '120px', justifyContent: 'center', alignItems: 'center', border: '1px solid #e9e9e9' }}>
                        <div style={{ paddingRight: '16px' }}>
                            <img src={SHEET_20_IMAGES[3]} alt="세련된 디자인" style={{ display: 'block', margin: 0 }} />
                        </div>
                        <div>
                            <span style={{ display: 'block', fontSize: '16px' }}>풍성한 컬러감으로 공간 연출</span>
                            <strong style={{ display: 'block', fontSize: '16px' }}>세련된 디자인</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{ display: 'flex', flexFlow: 'column', alignItems: 'center', marginBottom: '200px' }}>
                <div>
                    ...
                    <span style={{ display: 'block', paddingTop: '29px', fontSize: '14px', textAlign: 'center', wordSpacing: '-1px' }}>
                        &nbsp;LX Z:IN 바닥재 시트 스탠다드 2.0는 UV코팅/투명필름층, 디자인 인쇄층, 치수안정층, 쿠션층<br />
                        &nbsp;총 4단계로 구성되어 있습니다.
                    </span>
                </div>
                <div style={{ marginTop: '50px' }}>
                    <img src={SHEET_20_IMAGES[4]} alt="은행목 제품 구조도" style={{ display: 'block', margin: '0 auto' }} />
                </div>
            </div>
            ...
            <div style={{ marginBottom: '200px' }}>
                <ul style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'flex-start', margin: '45px -5px', padding: 0, listStyle: 'none' }}>
                    <li style={{ margin: '45px 5px', width: 'calc(50% - 10px)' }}>
                        <img src={SHEET_20_IMAGES[5]} alt="튼튼한 바닥재" style={{ display: 'block', margin: '0 auto' }} />
                        <div style={{ paddingTop: '24px' }}>
                            <p style={{ margin: 0, fontSize: '18px', fontWeight: 'bold', textAlign: 'center' }}>튼튼한 바닥재</p>
                            <p style={{ margin: 0, paddingTop: '20px', fontSize: '14px', textAlign: 'center' }}>
                                당사 1.8t 제품 대비 보다 두꺼운 표면층을 적용하여<br />오랫동안 처음 그대로의 모습으로 사용할 수 있습니다.
                            </p>
                        </div>
                    </li>
                    <li style={{ margin: '45px 5px', width: 'calc(50% - 10px)' }}>
                        <img src={SHEET_20_IMAGES[6]} alt="다양한 디자인" style={{ display: 'block', margin: '0 auto' }} />
                        <div style={{ paddingTop: '24px' }}>
                ...
                <table style={{ marginTop: '20px', width: '100%', borderCollapse: 'collapse', boxSizing: 'border-box' }}>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style={{ padding: '25px 20px', color: '#000000', fontSize: '16px', border: '1px solid #f1f1f1' }}>2.0mm(T) X 1,830mm(W)</td>
                            ...
                            <td style={{ padding: '25px 20px', color: '#000000', fontSize: '16px', border: '1px solid #f1f1f1' }}>1Roll</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <tbody>
                        <tr>
                            <td style={{ padding: '25px 20px', backgroundColor: '#ffffff', border: '1px solid #f1f1f1' }}>
                                <img src={SHEET_20_IMAGES[7]} alt="K-BPI" style={{ display: 'block', margin: '0 auto', width: '152px' }} />
                            </td>
                            <td style={{ padding: '25px 20px', backgroundColor: '#ffffff', border: '1px solid #f1f1f1' }}>
                                <img src={SHEET_20_IMAGES[8]} alt="환경표지인증" style={{ display: 'block', margin: '0 auto', width: '224px' }} />
                            </td>
                            <td style={{ padding: '25px 20px', backgroundColor: '#ffffff', border: '1px solid #f1f1f1' }}>
                                <img src={SHEET_20_IMAGES[9]} alt="실내표지" style={{ display: 'block', margin: '0 auto', width: '92px' }} />
                            </td>
                        </tr>
                        <tr>
...
export default SheetStandard20Feature;

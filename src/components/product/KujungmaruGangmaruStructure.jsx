...
import { KUJUNGMARU_GANGMARU_LINE_DETAILS } from './kujungmaruGangmaruLineDetails';

// 구정마루 강마루 라인별 STRUCTURE(단면도) + 차별화 기술 + 마케팅 카피
// 라인 데이터가 아직 없으면(kujungmaruGangmaruLineDetails.js 참고) 아무것도 렌더링하지 않는다.
function KujungmaruGangmaruStructure({ line }) {
    const detail = KUJUNGMARU_GANGMARU_LINE_DETAILS[line];
    ...
    return (
        <div className="w-full bg-white border-t border-slate-100">
            <div className="max-w-[1280px] mx-auto px-4 md:px-10 py-12">
                ...
                {detail.showDiagram !== false && <FloorStructureDiagram layers={detail.layers} />}
...
export default KujungmaruGangmaruStructure;

...
const faqs = [
    ...
    },
    {
        ...
        answer: '상품 수령 후 7일 이내에 고객센터(031-409-5556) 또는 이메일(timbach@naver.com)로 연락 주시기 바랍니다. 단, 박스를 개봉했거나 낱장으로 분리한 경우, 이미 시공이 시작된 경우에는 반품이 불가합니다.',
    },
    {
    ...
    },
    {
        ...
        answer: '모든 회원님께 동일한 가격으로 상품을 제공해 드립니다. 사업자 회원(B2B)으로 등록하시면 세금계산서 발행, 전담 매니저 배정 등 B2B 전용 혜택을 이용하실 수 있으며, 관리자에게 문의해 계정을 등록받으실 수 있습니다.',
    },
    {
        ...
        <main className="flex-1 px-4 md:px-20 py-8 max-w-[1280px] mx-auto w-full mb-20">
            ...
            <div className="mt-16 bg-primary/5 border border-primary/20 rounded-2xl p-8 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    <a href="tel:031-409-5556" className="px-6 py-3 bg-primary text-slate-900 font-bold rounded-xl hover:bg-primary/90 transition-all flex items-center gap-2">

...
const faqs = [
    ...
    },
    {
        ...
        answer: '고객센터(031-409-5556) 또는 이메일(timbach@naver.com)로 문의 주세요. 제품명, 구매일, 하자 내용을 알려주시면 빠르게 안내드리겠습니다.',
    },
];
        ...
        <main className="flex-1 px-4 md:px-20 py-8 max-w-[1280px] mx-auto w-full mb-20">
            ...
            <header className="mb-12">
                ...
                <p className="text-slate-500 max-w-2xl leading-relaxed">
                    데일리하우징은 LX Z:IN 공식 유통 파트너로서 최상의 품질을 보장합니다.
                </p>
            </header>
            ...
            <div className="mt-12 bg-slate-900 text-white rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap gap-3">
                    <a href="tel:031-409-5556" className="px-6 py-3 bg-primary text-slate-900 font-bold rounded-xl hover:bg-primary/90 transition-all flex items-center gap-2 whitespace-nowrap">

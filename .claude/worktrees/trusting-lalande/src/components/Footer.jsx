                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-16">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="flex items-center gap-4">
                            <img src="/assets/images/daily_housing_icon.svg" alt="데일리 하우징 로고" className="h-14 w-14" />
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><span className="text-[15px] font-normal text-slate-500 hover:text-[#d4a853] transition-colors cursor-pointer">에디톤 우드 / 스톤 / 스퀘어</span></li>
                            <li><span className="text-[15px] font-normal text-slate-500 hover:text-[#d4a853] transition-colors cursor-pointer">시트 & 타일</span></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-[16px] font-bold text-slate-900">{contact.phone || '02-1234-5678'}</p>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <p className="text-[15px] font-normal text-slate-500">{contact.email || 'contact@dailyhousing.co.kr'}</p>
                            </div>
                            <div className="flex items-start gap-3">
            ...
            <div className="bg-slate-50 border-t border-slate-200 px-4 sm:px-6 lg:px-16 xl:px-24 py-5 sm:py-6 mt-4">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="text-[13px] font-normal text-slate-400 text-center md:text-left leading-relaxed">
                        <p>대표: 홍길동 | 사업자등록번호: 123-45-67890 | 통신판매업 신고번호: 2026-서울강남-12345</p>
                        <p className="mt-1">© 2026 데일리 하우징. All rights reserved.</p>

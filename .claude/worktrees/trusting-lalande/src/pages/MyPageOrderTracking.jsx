        ...
        <main className="max-w-5xl mx-auto px-4 py-8 mb-20">
            ...
            <section className="bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-800 mb-10 overflow-x-auto">
                <div className="flex justify-between items-start relative min-w-[700px] px-4">
                    ...
                    <div className="absolute top-6 left-0 w-3/4 h-1 bg-primary z-0"></div>
                    <div className="relative z-10 flex flex-col items-center gap-4 flex-1">
                        <div className="w-12 h-12 rounded-full bg-primary text-slate-900 flex items-center justify-center shadow-lg shadow-primary/20">
                            <span className="material-symbols-outlined font-bold">pending_actions</span>
                        </div>
                        <div className="text-center">
                            <p className="text-sm font-bold text-slate-900 dark:text-slate-100">입금대기</p>
                            <p className="text-[11px] text-slate-500">10/24 09:12</p>
                        </div>
                    </div>
                    <div className="relative z-10 flex flex-col items-center gap-4 flex-1">
                        <div className="w-12 h-12 rounded-full bg-primary text-slate-900 flex items-center justify-center shadow-lg shadow-primary/20">
                        ...
                        <div className="text-center">
                            <p className="text-sm font-bold text-slate-900 dark:text-slate-100">결제완료</p>
                            <p className="text-[11px] text-slate-500">10/24 10:30</p>
                        </div>
                    </div>
                    <div className="relative z-10 flex flex-col items-center gap-4 flex-1">
                        <div className="w-12 h-12 rounded-full bg-primary text-slate-900 flex items-center justify-center shadow-lg shadow-primary/20">
                        ...
                        <div className="text-center">
                            <p className="text-sm font-bold text-slate-900 dark:text-slate-100">배송준비중</p>
                            <p className="text-[11px] text-slate-500">10/24 14:15</p>
                        </div>
                    </div>
                    <div className="relative z-10 flex flex-col items-center gap-4 flex-1">
                        <div className="w-12 h-12 rounded-full bg-primary text-slate-900 flex items-center justify-center ring-4 ring-primary/30 shadow-lg shadow-primary/20">
                            <span className="material-symbols-outlined font-bold">local_shipping</span>
                        </div>
                        <div className="text-center">
                            <p className="text-sm font-bold text-slate-900 dark:text-slate-100">배송중</p>
                            <p className="text-[11px] text-primary font-bold">이동 중 (10/25)</p>
                        </div>
                    </div>
                    <div className="relative z-10 flex flex-col items-center gap-4 flex-1">
                        ...
                        <div className="text-center">
                            <p className="text-sm font-bold text-slate-400">배송완료</p>
